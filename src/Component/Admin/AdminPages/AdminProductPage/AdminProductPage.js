        ...
        <Fade in={open}>
          ...
          >
            ...
            <form className="modal_form">
              ...
              <span>
                <select>
                  <option className="select_modal_option">
                    Category of Product{" "}
                  </option>
                  <option className="select_modal_option">BlueStone</option>
                  <option className="select_modal_option">BlueStone</option>
                  <option className="select_modal_option">BlueStone</option>
                  <option className="select_modal_option">BlueStone</option>
                </select>
              ...
              <input type="file" />
              <div className="modal_form_product_unit">
                <div className="modal_form_product_unit_weight">
                  <p>Product Unit Weight</p>
                  <span>
                    <select>
